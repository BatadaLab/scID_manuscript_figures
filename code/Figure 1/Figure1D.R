...
scID_output <- scid_multiclass(target_gem = gem, reference_gem = gem, reference_clusters = labels, 
                               logFC = 0.5, use_reference_for_weights = F, likelihood_threshold = 0.99)
...
scID_output <- scid_multiclass(target_gem = gem, reference_gem = gem, reference_clusters = labels, 
                               logFC = 0.5, use_reference_for_weights = F, likelihood_threshold = 0.95)
scID_labels <- scID_output$labels
...
scID_output <- scid_multiclass(target_gem = gem, reference_gem = gem, reference_clusters = labels, 
                               logFC = 0.3, use_reference_for_weights = F, likelihood_threshold = 1)
scID_labels <- scID_output$labels
...
scID_output <- scid_multiclass(target_gem = gem, reference_gem = gem, reference_clusters = labels, 
                               logFC = 0.9, use_reference_for_weights = F, likelihood_threshold = 0.99)
scID_labels <- scID_output$labels
